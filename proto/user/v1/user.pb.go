...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\"E\n" +
	...
	"\faccess_token\x18\x03 \x01(\tR\vaccessToken2T\n" +
	"\vUserService\x12E\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponseB-Z+go-template/internal/grpc/pb/user/v1;userv1b\x06proto3"
